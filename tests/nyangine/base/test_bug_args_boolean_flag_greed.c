...
NYA_INTERNAL void test_attached_true(void) {
  Fixture fixture;
  fixture_init(&fixture);
...
NYA_INTERNAL void test_typed_flag_takes_attached_value(void) {
  Fixture fixture;
  fixture_init(&fixture);
...
NYA_INTERNAL void test_attached_value_containing_equals(void) {
  Fixture fixture;
  fixture_init(&fixture);
...
s32 main(void) {
  ...
  test_boolean_flag_does_not_eat_positional();
  test_positional_that_looks_like_a_boolean();
  test_attached_false();
  test_attached_true();
  test_nonsense_attached_value_is_refused();
  test_typed_flag_takes_following_value();
  test_typed_flag_takes_attached_value();
  test_typed_flag_with_nothing_after_it();
  test_unknown_flag_name_is_still_unknown();
  test_empty_attached_value();
  test_attached_value_containing_equals();
