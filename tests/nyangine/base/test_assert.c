...
s32 main(void) {
  ...
  // TEST: nya_expect_crash - fails when no panic occurs We can't test this directly without causing a test failure, but we verify the mechanism works with a known panic above.
