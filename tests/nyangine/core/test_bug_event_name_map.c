...
s32 main(void) {
    ...
    // TEST: the same property for every other name map in the tree Every one is a designated initialiser table indexed by an enum, and any can gain an enumerator without a row.
