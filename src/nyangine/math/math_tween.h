...
NYA_API f32 nya_ease(NYA_EaseType type, f32 t);
NYA_API f32 nya_ease_bezier(f32 x1, f32 y1, f32 x2, f32 y2, f32 t);
NYA_API f32 nya_ease_spring(f32 t, f32 frequency, f32 damping);
