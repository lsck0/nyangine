...
/**
 * "Somebody wants to join", over whatever is on screen. Pushed by a join request, popped when answered.
 * */
NYA_ConstCString GNY_LAYER_SOCIAL_ID = "gny_layer_social";
NYA_Layer        GNY_LAYER_SOCIAL;
