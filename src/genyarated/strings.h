...
/*
 * Generated from ./assets/i18n/en.json by src/nyangine-build/i18n.c. One entry and one accessor per key of the base
...
/** `cube3d_decals` */
static inline __attr_allow_unused NYA_ConstCString nya_string_cube3d_decals(void) {
    return _nya_i18n_format(NYA_STRING_CUBE3D_DECALS);
}
...
/** `cube3d_simulation` */
static inline __attr_allow_unused NYA_ConstCString nya_string_cube3d_simulation(f64 a0, f64 a1, f64 a2) {
    return _nya_i18n_format(NYA_STRING_CUBE3D_SIMULATION, a0, a1, a2);
}
