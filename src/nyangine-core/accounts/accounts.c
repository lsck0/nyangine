...
#include "nyangine-core/accounts/accounts_throttle.c"
/**/
// accounts_user.c first: it owns the module's static state and the two tables the session half uses.
#include "nyangine-core/accounts/accounts_user.c"
/**/
#include "nyangine-core/accounts/accounts_session.c"
// last: it names the users table, the sessions table and both of their halves.
#include "nyangine-core/accounts/accounts_identity.c"
// last: it names the recovery table on the state the user half owns, and the throttle.
#include "nyangine-core/accounts/accounts_recovery.c"
// after the user half, whose tables it names, and over crypto's Ed25519 verify and serde's CBOR reader.
#include "nyangine-core/accounts/accounts_passkey.c"
#include "nyangine-core/accounts/accounts_invite.c"
#include "nyangine-core/accounts/accounts_audit.c"
