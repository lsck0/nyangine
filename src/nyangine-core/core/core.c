#include "nyangine-core/core/core_app.c"
#include "nyangine-core/core/core_skeleton.c"
#include "nyangine-core/core/core_skeleton_inertial.c"
#include "nyangine-core/core/core_asset.c"
...
#include "nyangine-core/core/core_config.c"
// the chain before the system that owns one per bus, and propagation after it, since it steers its voices.
#include "nyangine-core/core/core_audio_effects.c"
// the pure panner primitive before the system that composes it onto a voice.
#include "nyangine-core/core/core_audio_panner.c"
#include "nyangine-core/core/core_audio.c"
#include "nyangine-core/core/core_audio_propagation.c"
...
#include "nyangine-core/core/core_http_reload.c"
#include "nyangine-core/core/core_control.c"
#include "nyangine-core/core/core_entity.c"
#include "nyangine-core/core/core_event.c"
#include "nyangine-core/core/core_i18n.c"
#include "nyangine-core/core/core_gamepad.c"
#include "nyangine-core/core/core_input.c"
#include "nyangine-core/core/core_job.c"
// After core_job.c and core_callback.c: it fans work onto the job pool and rides its tasks on a callback.
#include "nyangine-core/core/core_taskgroup.c"
#include "nyangine-core/core/core_keys.c"
#include "nyangine-core/core/core_save.c"
// After core_save.c and core_world.c's header: a scene is a world written through the save root.
#include "nyangine-core/core/core_scene.c"
#include "nyangine-core/core/core_settings.c"
#include "nyangine-core/core/core_sim.c"
...
#include "nyangine-core/core/core_social.c"
#include "nyangine-core/core/core_terrain2d.c"
#include "nyangine-core/core/core_terrain3d.c"
#include "nyangine-core/core/core_skeleton_layer.c"
#include "nyangine-core/core/core_skeleton_blend.c"
#include "nyangine-core/core/core_system.c"
...
#include "nyangine-core/core/core_plugin.c"
...
#include "nyangine-core/core/core_window.c"
#include "nyangine-core/core/core_world.c"
