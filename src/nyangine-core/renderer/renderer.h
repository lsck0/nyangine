...
#include "nyangine-core/renderer/render_camera.h"
...
#include "nyangine-core/renderer/render_features.h"
...
#include "nyangine-core/renderer/render_occlusion.h"
...
#include "nyangine-core/renderer/render_post.h"
// the window holds the volumetric's parameter block by value; its compute pass, below the header's guard, reads it.
#include "nyangine-core/renderer/render_compute_volumetric.h"
// the window holds the decal and output options and what they allocate.
#include "nyangine-core/renderer/render3d_decal.h"
#include "nyangine-core/renderer/render_output.h"
...
#include "nyangine-core/renderer/render_sort.h"
#include "nyangine-core/renderer/render_lut.h"
#include "nyangine-core/renderer/render_lod.h"
#include "nyangine-core/renderer/render_gpu_memory.h"
#include "nyangine-core/renderer/render_text.h"
#include "nyangine-core/renderer/render_font.h"
