 ...
 *
 * Producing Windows binaries on a Windows host. Native, so no target triple and no cross tooling.
 *
 * The rules themselves are identical to on_linux/build_windows.h; only the tooling below differs.
 * */
#pragma once
