...
NYA_INTERNAL const _LintAllowed _LINT_CALLERS_ALLOWED[] = {
    ...
    // core_window.h
    { "nya_layer_disable", "no caller when the rule landed" },
    { "nya_layer_enable", "no caller when the rule landed" },
    { "nya_video_driver", "no caller when the rule landed" },
    { "nya_window_display_mode", "no caller when the rule landed" },
    { "nya_window_flash", "no caller when the rule landed" },
    { "nya_window_hide", "no caller when the rule landed" },
    { "nya_window_is_mouse_grabbed", "no caller when the rule landed" },
    { "nya_window_is_relative_mouse", "no caller when the rule landed" },
    { "nya_window_opacity", "no caller when the rule landed" },
    { "nya_window_position", "no caller when the rule landed" },
    { "nya_window_region_set", "no caller when the rule landed" },
    { "nya_window_request_aspect_ratio", "no caller when the rule landed" },
    { "nya_window_request_maximum_size", "no caller when the rule landed" },
    { "nya_window_request_minimum_size", "no caller when the rule landed" },
    { "nya_window_request_position", "no caller when the rule landed" },
    { "nya_window_request_size", "no caller when the rule landed" },
    { "nya_window_set_focusable", "no caller when the rule landed" },
    { "nya_window_set_mouse_grabbed", "no caller when the rule landed" },
    { "nya_window_set_opacity", "no caller when the rule landed" },
    { "nya_window_set_relative_mouse", "no caller when the rule landed" },
    { "nya_window_size", "no caller when the rule landed" },
    { "nya_window_size_in_pixels", "no caller when the rule landed" },
    { "nya_window_sync", "no caller when the rule landed" },
    // http_message.h
