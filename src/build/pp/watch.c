...
void nya_watch_generate(void) {
    NYA_ConstCString inputs[] = {
        NYA_WATCH_TREE_ENGINE, NYA_WATCH_TREE_GAME, NYA_WATCH_TREE_EXAMPLES, NYA_WATCH_TREE_TESTS, "./src/build/pp/watch.c", nullptr,
    };
    ...
    nya_string_extend(manifest,
                      "# GENERATED by src/build/pp/watch.c. DO NYAT EDIT.\n"
                      "#\n"
...
void _nya_watch_emit_companion(const _NYA_WatchSet* set, u32 source, NYA_String* out) {
    ...
    nya_string_extend_sprintf(out,
                              "/*\n"
                              " * GENERATED by src/build/pp/watch.c from the " NYA_WATCH_MARKER " annotations in %s. DO NYAT EDIT.\n"
                              " *\n"
