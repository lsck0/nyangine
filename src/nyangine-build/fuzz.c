    ...
    NYA_BuildRule run_rule = {
        ...
        .command = {
            ...
            .environment = {
                ...
                "ASAN_OPTIONS=suppressions=./src/nyangine-build/sanitizers/asan.supp:detect_leaks=1:strict_string_checks=1:halt_on_error=1:abort_on_error=1:symbolize=0",
                "LSAN_OPTIONS=suppressions=./src/nyangine-build/sanitizers/lsan.supp:symbolize=0",
                "TSAN_OPTIONS=suppressions=./src/nyangine-build/sanitizers/tsan.supp:symbolize=0",
                "UBSAN_OPTIONS=suppressions=./src/nyangine-build/sanitizers/ubsan.supp:print_stacktrace=1:halt_on_error=1:abort_on_error=1:symbolize=0",
