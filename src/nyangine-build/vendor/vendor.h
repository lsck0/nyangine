...
#include "nyangine-build/vendor/vendor_box2d.h"
#include "nyangine-build/vendor/vendor_box3d.h"
#include "nyangine-build/vendor/vendor_common.h"
#include "nyangine-build/vendor/vendor_curl.h"
#include "nyangine-build/vendor/vendor_libbacktrace.h"
#include "nyangine-build/vendor/vendor_lua.h"
#include "nyangine-build/vendor/vendor_lz4.h"
#include "nyangine-build/vendor/vendor_monocypher.h"
// a rule with no parts: the system's OpenSSL, for the reason its own file gives.
#if !OS_WINDOWS
#include "nyangine-build/vendor/vendor_openssl.h"
#endif
#include "nyangine-build/vendor/vendor_sdl.h"
#include "nyangine-build/vendor/vendor_sdl_image.h"
#include "nyangine-build/vendor/vendor_sdl_mixer.h"
#include "nyangine-build/vendor/vendor_sdl_shadercross.h"
#include "nyangine-build/vendor/vendor_sdl_ttf.h"
#include "nyangine-build/vendor/vendor_sqlean.h"
#include "nyangine-build/vendor/vendor_sqlite.h"
#include "nyangine-build/vendor/vendor_sqlvec.h"
// a Linux host target: the sysroot is unpacked with symlinks, and the rules run make and configure directly.
#if !OS_WINDOWS
#include "nyangine-build/vendor/vendor_steamrt.h"
#endif
#include "nyangine-build/vendor/vendor_ufbx.h"
