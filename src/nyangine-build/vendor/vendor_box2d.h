...
NYA_VendorRule vendor_box2d_linux_x86_64 = {
    .options_file  = "./src/nyangine-build/vendor/vendor_box2d.h",
...
#else
#define BOX2D_WINDOWS_C_FLAGS "-DCMAKE_C_FLAGS=-I%CWD%/src/nyangine-build/compat -DB2_MAX_WORLDS=" BOX2D_MAX_WORLDS,
#endif
