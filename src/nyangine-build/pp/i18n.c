...
void nya_i18n_generate(void) {
    NYA_ConstCString inputs[]  = { NYA_I18N_DIRECTORY, "./src/nyangine-build/pp/i18n.c", nullptr };
    ...
    nya_string_extend_sprintf(
        out,
        "/*\n"
        " * Generated from %s by src/nyangine-build/i18n.c. One entry and one accessor per key of the base\n"
