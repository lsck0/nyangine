...
void nya_lambda_generate(void) {
    NYA_ConstCString inputs[] = {
        NYA_LAMBDA_TREE_ENGINE, NYA_LAMBDA_TREE_GAME, NYA_LAMBDA_TREE_EXAMPLES, NYA_LAMBDA_TREE_TESTS, "./src/nyangine-build/pp/lambda.c", nullptr,
    };
    ...
    nya_string_extend(manifest,
                      "# GENERATED by src/nyangine-build/pp/lambda.c. DO NYAT EDIT.\n"
                      "#\n"
...
void _nya_lambda_emit_companion(const _NYA_LambdaSet* set, u32 source, NYA_String* out) {
    ...
    nya_string_extend_sprintf(out,
                              "/*\n"
                              " * GENERATED by src/nyangine-build/pp/lambda.c from the nya_lambda bodies in %s. DO NYAT EDIT.\n"
                              " *\n"
